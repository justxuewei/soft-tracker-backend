...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    private static final String CLIENT_ID = "lucius-client";
    private static final String CLIENT_SECRET = "{bcrypt}$2y$12$DwM43fA/U8AzcjIhxdrziukdHryNHM6./Pg7mLmGTPPDBiQeM3JZm\n";
